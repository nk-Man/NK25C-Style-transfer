...
if __name__ == "__main__":
    ...
    from utils import style_loader, content_loader, CONTENT_WEIGHT, STYLE_WEIGHT,LR
    ...
    model  = StyleTransferNet(decoder_ckpt='./decoder333.pth', device=device)
    ...
    try:
        ...
        torch.save(decoder.state_dict(), "decoder444.pth")
        print("模型已保存为 decoder444.pth")
