...
'''
class Caltech101ImagesOnly(Caltech101):
    def __getitem__(self, idx):
        img, _ = super().__getitem__(idx)  # 忽略标签
        if self.transform:
...
content_loader = DataLoader(content_dataset, batch_size=16, shuffle=True, num_workers=0,drop_last=True)
